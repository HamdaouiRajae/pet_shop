...
<div class="center_content">
	<div class="left_content">
		...
		<div class="feat_prod_box_details">
			<p class="details">
				Chez Pet Shop, nous nous efforçons de vous aider à  mettre la main
				sur tout ce que votre animal adorera. Tous les produits que vous
				commandez, nous les livrons directement à  votre porte.<br />
				<br /> Toute livraison est entièrement gratuite pour les commandes
				supérieures à 300DH. La philosophie de notre entreprise est assez
				...
				large possible de produits les mieux notéss au meilleur prix
				possible partout en Inde, combiné avec le meilleur service possible
				et une livraison rapide des produits à  votre porte.
			</p>
...
https://translate.google.fr/?hl=fr&sl=en&tl=es&op=translate"><img
		...
		<div class="about">
			<p>
				...
				Shop est également une animalerie en ligne pouvant livrer à 
				domicile vos commandes partout au Maroc. Que vous soyez à 
				Casablanca, Rabat, Marrakech, Tanger ou Fèz, nous pouvons assurer
				pour vous une livraison à domicile dans les plus brefs délais.
			</p>
