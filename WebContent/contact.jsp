...
<div class="center_content">
	<div class="left_content">
		...
		<div class="feat_prod_box_details">
			...
			<table class="container_contact">
				<thead>
					<tr>
						<th><h1>Social Media</h1></th>
						<th><h1>Infos</h1></th>
					</tr>
				</thead>
				<tbody>
				...
				<div class="contact_form">
					...
					<div class="form_row">
						<label class="contact"><strong>Name:</strong></label> <input
							type="text" class="contact_input" name="name" />
					</div>
					...
					<div class="form_row">
						<label class="contact"><strong>Phone:</strong></label> <input
							type="text" class="contact_input" name="phone" />
					</div>

					<div class="form_row">
						<label class="contact"><strong>Company:</strong></label> <input
							type="text" class="contact_input" name="company" />
					</div>
					...
					<div class="form_row">
						<a href="www.gmail.com" class="contact">send</a>
					</div>
				</div>
				<div class="form_row">
					<div class="terms">
...
https://translate.google.fr/?hl=fr&sl=en&tl=es&op=translate"><img
		...
		<div class="about">
			<p>
				...
				Désormais, il n'est plus nécessaire de conduire et de rechercher les
				animaleries, puis de jongler avec quoi acheter? Que partir? Vous
				pouvez tout oublier, mais aprés tous ces problémes, la meme vieille
				cuisine, la meme vieille remise et la meme vieille mode. Nous
				comprenons votre dilemme donc tout ce que vous avez à faire est de
				visiter notre site Web et de choisir ce que vous voulez et meme si
				vous avez un doute, nos experts et notre service client sont
				disponibles 24h / 24 et 7j / 7 à  vos services.
			</p>
